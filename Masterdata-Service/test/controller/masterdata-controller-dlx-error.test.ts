...
describe("Check class \'Masterdata Controller\'to handle deadletter queue 400 error ", () => {
    ...
    test('get MasterdataDeadletter Queue MessagesCount should 400 when all is good but channel error', async () => {
        ...
        const eventResponse = {
            "message": "Couldn't create or confirm RabbitMQ channel.",
            "success": false
        };
    ...
    test('retry MasterdataDeadletter Queue Message should 500 when all is good, masterdata paused but channel error', async () => {
        const req = mockRequest();
        req.params.orgId = 1;
    ...
    test('retry MasterdataDeadletter Queue Message should 500 when all is good, masterdata not paused but channel error', async () => {
        const req = mockRequest();
        req.params.orgId = 1;
