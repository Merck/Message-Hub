...
import {MasterDataController} from "./controller/masterdata-controller";
...
const routerController = new RouterController([
    new MasterDataController(), new HealthCheckController()
], (process.env.MASTERDATA_SERVICE_LOCAL_PORT as unknown) as number || 8080);
