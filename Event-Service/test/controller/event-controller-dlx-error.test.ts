...
describe("Check class \'EventController\'to handle deadletter queue ", () => {
    ...
    test('get EventDeadletter Queue MessagesCount should 400 when all is good but channel error', async () => {
    ...
    test('retry EventDeadletter Queue Message should 500 when all is good and events not paused but channel error', async () => {
        const req = mockRequest();
        req.params.orgId = 1;
    ...
    test('retry EventDeadletter Queue Message should 500 when all is good and events  paused but channel error', async () => {
        const req = mockRequest();
        req.params.orgId = 1;
