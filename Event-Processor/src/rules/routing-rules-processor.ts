            ...
            .then(results => {
                if (results.data) {
                    for (let i = 0; i < results.data.length; i++) {
                        ...
                        if (eventType === routingRule.datafield_type) {
                            let jsonRule = {
                                conditions: {
                                    any: [
                                        {
