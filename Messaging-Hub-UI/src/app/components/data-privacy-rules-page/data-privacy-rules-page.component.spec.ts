...
import { DataPrivacyRulesPageComponent } from './data-privacy-rules-page.component';
import { of } from 'rxjs';

describe('DataPrivacyRulesPageComponent', () => {
	...
	let component: DataPrivacyRulesPageComponent;
	beforeEach(async(() => {
		privacyServiceMock = {
			getPrivacyRulesHistory: jest.fn().mockImplementation(() => of(successResponse))
		}
		...
		TestBed.configureTestingModule({
			declarations: [DataPrivacyRulesPageComponent]
		});
		component = new DataPrivacyRulesPageComponent(privacyServiceMock, translateServiceMock, authServiceMock, errorHandlerMock);
		component.ngOnInit();
	}));
