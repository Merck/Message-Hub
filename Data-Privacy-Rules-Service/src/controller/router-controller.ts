...
if( !process.env.DATA_PRIVACY_RULES_SERVICE_LOCAL_PORT ){
...
const options = {
    definition: {
        openapi: '3.0.0',
        info: {
            title: 'Messaging Hub Data Privacy Rules Microservice',
...
export class RouterController {
    ...
    public listen() {
        this.service.listen(this.port, () => {
            logger.info(`Data Privacy Rules Service started on PORT : [ ${this.port} ]`);
        })
    }
}